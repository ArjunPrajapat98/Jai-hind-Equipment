      ...
      <div className="__mainContainer">
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
          <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            {/* Breadcrumb */}
            <div className="mb-8">
              <Link href='/' className="inline-flex items-center theme-primary hover:text-blue-800 transition-colors group theme-font-primary">
                <svg className="w-4 h-4 mr-2 transition-transform group-hover:-translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                </svg>
                Home
              </Link>
              <span className="mx-2 theme-text-light">/</span>
              <span className="theme-text-secondary font-medium theme-font-primary">Enquiry Now</span>
            </div>
              ...
              <div className="relative">
                <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-blue-100 transform hover:shadow-2xl transition-all duration-300">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <h1 className="text-theme-3xl font-bold theme-text-primary mb-2 philosopher-bold">Jai Hind Equipment Pvt. Ltd.</h1>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4 group">
                      <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-blue-200 transition-colors">
                        <svg className="w-5 h-5 theme-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <div>
                        <h3 className="text-theme-sm font-semibold theme-text-muted uppercase tracking-wider mb-1 theme-font-primary">Contact Person</h3>
                        <p className="theme-text-primary font-medium theme-font-primary">Mr. Rahul Prajapat</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4 group">
                      ...
                      <div>
                        <h3 className="text-theme-sm font-semibold theme-text-muted uppercase tracking-wider mb-1 theme-font-primary">Address</h3>
                        <p className="theme-text-primary theme-font-primary">
                    ...
                    <div className="flex items-start space-x-4 group">
                      ...
                      <div>
                        <h3 className="text-theme-sm font-semibold theme-text-muted uppercase tracking-wider mb-1 theme-font-primary">Call Us</h3>
                        <a href="tel:8305033403" className="theme-primary hover:text-blue-800 font-medium transition-colors inline-flex items-center theme-font-primary">
                          8305033403
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-4 group">
                        ...
                        <div className="flex-1">
                          <h3 className="text-theme-sm font-semibold theme-text-muted uppercase tracking-wider mb-1 theme-font-primary">Web Address</h3>
                          <a
                            href="https://jaihindequipment.co.in"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="theme-primary hover:text-blue-800 transition-colors break-words inline-flex items-center theme-font-primary"
                          >
                    ...
                    <div className="pt-6 mt-6 border-t border-gray-200">
                      <div className="text-center">
                        <h3 className="text-theme-sm font-semibold theme-text-muted uppercase tracking-wider mb-4 theme-font-primary">Quick Contact</h3>
                            ...
                            <div className="w-full h-full bg-gradient-to-br from-blue-200 to-indigo-300 rounded-lg flex items-center justify-center">
                              <div className="text-center">
                                <div className="w-12 h-12 bg-white rounded-lg mx-auto mb-2 flex items-center justify-center shadow-sm">
                                  <svg className="w-6 h-6 theme-primary" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z" />
                                  </svg>
                                </div>
                                <span className="text-blue-800 font-medium text-theme-sm theme-font-primary">QR Code</span>
                              </div>
                            </div>
                          </div>
                          <p className="theme-text-muted text-theme-sm font-medium theme-font-primary">Scan for contact information</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="relative">
                <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-blue-100 transform hover:shadow-2xl transition-all duration-300">
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-theme-3xl font-bold theme-text-primary mb-2 philosopher-bold">Get In Touch</h2>
                    <p className="theme-text-muted theme-font-primary">We'd love to hear from you. Send us your enquiry.</p>
                  ...
                  <form className="space-y-6">
                    <div>
                      ...
                      <select
                        id="product-service"
                        className="w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white appearance-none theme-font-primary"
                        required
                      >
